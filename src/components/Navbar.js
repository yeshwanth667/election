      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          >
            ...
            <li className="nav-item">
              <select
                style={{marginTop:'4px',backgroundColor:'#ce7d7d',color:'black',fontSize:'18px'}}
                className="form-select"
                aria-label="More Services"
                onChange={(e) => (window.location.href = e.target.value)}
              >
                <option style={{backgroundColor:'white',color:'black'}} value="">More Services</option>
                <option style={{backgroundColor:'white',color:'black'}} value={`/updatepassword/${userId}`}>
                  Change Password
                </option>
              </select>
            </li>
          ...
          <ul className="navbar-nav ms-auto">
            <li style={{textAlign:'center'}} className="nav-item">
              ...
              <div style={{ color: "black",fontSize:'17px' }} className="nav-link">
                <b>
...
//       </div>
//       <Modal isOpen={isModalOpen} onClose={toggleModal} />
//       <Dashboard ref={dashboardRef} highlighted={highlighted} />
//     </nav>
//   );
// }
